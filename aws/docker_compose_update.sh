...
sudo curl -s https://raw.githubusercontent.com/sublime-security/sublime-platform/staging/aws/docker-compose-latest.yml -o /home/ubuntu/Sublime-Security/docker-compose.yml
